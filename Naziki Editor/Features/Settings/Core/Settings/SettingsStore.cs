...
namespace Naziki_Editor.Core.Settings
{
    ...
    public class SettingsStore : ISettingsStore
    {
        ...
        public void RegisterDefaultCategories()
        {
            ...
            RegisterCategory(CreatePlaybackCategory());
        ...
        private static SettingsCategory CreateEditorCategory()
        {
            return new SettingsCategory
            {
                ...
                Items = new List<SettingItem>
                {
                    ...
                    new()
                    {
                        Key = "Editor.PreviewAspectRatio",
                        DisplayName = "预览设备比例",
                        Description = "Canvas 中 Unity 预览窗口使用的设备宽高比",
                        ValueType = SettingValueType.Combo,
                        DefaultValue = "16:9",
                        ComboOptions = new List<string> { "16:9", "4:3", "21:9" },
                        Order = 5
                    }
                }
            };
        ...
        private static SettingsCategory CreatePerformanceCategory()
        {
            return new SettingsCategory
            {
                ...
                Items = new List<SettingItem>
                {
                    ...
                    new()
                    {
                        Key = "Performance.PreviewRenderScale",
                        DisplayName = "预览渲染比例",
                        Description = "Unity 原生预览相对于 Canvas 物理像素尺寸的渲染比例",
                        ValueType = SettingValueType.Combo,
                        DefaultValue = "100%",
                        ComboOptions = new List<string> { "50%", "75%", "100%", "125%" },
                        Order = 4
                    },
                    new()
                    {
                        Key = "Performance.PreviewFrameRate",
                        DisplayName = "预览帧率",
                        Description = "原生预览的目标帧率；Display 使用显示器垂直同步",
                        ValueType = SettingValueType.Combo,
                        DefaultValue = "60",
                        ComboOptions = new List<string> { "30", "60", "90", "120", "Display" },
                        Order = 5
                    },
                    new()
                    {
                        Key = "Performance.PreviewAdaptiveQuality",
                        DisplayName = "自适应预览质量",
                        Description = "持续超出帧耗时阈值时临时降低渲染比例，稳定后逐级恢复",
                        ValueType = SettingValueType.Bool,
                        DefaultValue = true,
                        Order = 6
                    },
                    new()
                    {
                        Key = "Performance.PreviewInactiveFrameRate",
                        DisplayName = "后台预览帧率",
                        Description = "Canvas 被其他标签遮挡但保持暖驻留时使用的目标帧率",
                        ValueType = SettingValueType.Integer,
                        DefaultValue = 15,
                        MinValue = 1,
                        MaxValue = 60,
                    ...
                    new()
                    {
                        Key = "Performance.PreviewExternalClockRate",
                        DisplayName = "编辑器音频同步频率",
                        Description = "编辑器音频作为主时钟时，每秒向 Unity 同步画面的次数",
                        ValueType = SettingValueType.Combo,
                        DefaultValue = "50",
                        ComboOptions = new List<string> { "30", "50", "60" },
                        Order = 8
                    },
                    new()
                    {
                        Key = "Performance.PreviewAdaptiveMinimumScale",
                        DisplayName = "自适应最低渲染比例",
                        Description = "自动降质时允许使用的最低内部渲染比例",
                        ValueType = SettingValueType.Combo,
                        DefaultValue = "50%",
                        ComboOptions = new List<string> { "50%", "75%", "100%" },
                        Order = 9
                    }
                }
            };
        ...
        private static SettingsCategory CreatePlaybackCategory()
        {
            return new SettingsCategory
            {
                Key = "Playback",
                DisplayName = "播放与同步",
                Icon = "▶️",
                Description = "选择关卡预览与编辑器时间轴的主时钟",
                Order = 5,
                Items = new List<SettingItem>
                {
                    new()
                    {
                        Key = "Playback.PrimaryClock",
                        DisplayName = "播放主时钟",
                        Description = "Unity Preview 保证游戏画面与音乐同步；EditorAudio 使用编辑器音频驱动画面。更改在下一次播放时生效。",
                        ValueType = SettingValueType.Combo,
                        DefaultValue = "UnityPreview",
                        ComboOptions = new List<string> { "UnityPreview", "EditorAudio" },
                        Order = 0
                    }
                }
            };
