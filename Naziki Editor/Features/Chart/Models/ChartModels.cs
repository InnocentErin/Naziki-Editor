...
namespace Naziki_Editor.Models
{
    ...
    public class C2Chart
    {
        ...
        public double? start_offset_time { get; set; }
        public double? end_offset_time { get; set; }
        public bool? is_start_without_ui { get; set; }
        public double? size { get; set; }
        public double? opacity { get; set; }
        public string? ring_color { get; set; }
        public List<string>? fill_colors { get; set; }
        public bool? display_boundaries { get; set; }
        public bool? display_background { get; set; }
        public int? horizontal_margin { get; set; }
        public int? vertical_margin { get; set; }
        public bool? restrict_play_area_aspect_ratio { get; set; }
    ...
    public class C2Page
    {
        public double start_tick { get; set; }
        public double end_tick { get; set; }
        public int scan_line_direction { get; set; }
        [JsonProperty("PositionFunction")]
        public C2PagePositionFunction? PositionFunction { get; set; }
        [JsonExtensionData]
        public IDictionary<string, JToken> UnknownProperties { get; set; } =
            new Dictionary<string, JToken>(StringComparer.Ordinal);
    }

    public class C2PagePositionFunction
    {
        [JsonProperty("Type")]
    ...
    public class C2Note
    {
        ...
        // 📏 长按音符持续长度 (极为关键)
        public double hold_tick { get; set; }

        // 🔗 锁链/滑条指向 note_list 中的下一个索引 (-1 表示链条结束)
