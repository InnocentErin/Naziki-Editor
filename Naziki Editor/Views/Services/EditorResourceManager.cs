...
namespace Naziki_Editor.Views.Services
{
    ...
    public class EditorResourceManager
    {
        ...
        public string CurrentNoteSkin { get; set; } = "Cytus2_Default";
        public string CurrentNoteSound { get; set; } = "Cytus2_Default";

        // 🧊 冰封缓存池：内存 OOM 终极防御盾
        private Dictionary<string, BitmapImage> _noteIconCache = new Dictionary<string, BitmapImage>();

        /// <summary>
        /// 🧙‍♂️ 召唤音符图标：双层嗅探法术！
        /// </summary>
        public BitmapImage GetNoteIcon(int noteType)
        {
